  ...
  return (
    <InfoPageLayout title="Returns" subtitle="Our return policy is designed to give you confidence in every purchase.">
      <div className="space-y-8 text-dark-muted leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-dark-text mb-2">7-Day Return Window</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-dark-text mb-2">How to Initiate a Return</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-dark-text mb-2">Restocking Fee</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-dark-text mb-2">Non-Returnable Items</h2>
          <p>
